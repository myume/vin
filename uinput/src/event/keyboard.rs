...
#[derive(Display, Clone, Copy, PartialEq, Eq, Hash, Debug, EnumString, EnumIter)]
...
pub enum Key {
    ...
    #[strum(serialize = "0")]
    _0,
    #[strum(serialize = "-", serialize = "Minux")]
    Minus,
    #[strum(serialize = "=", serialize = "Equal")]
    Equal,
    BackSpace,
    Tab,
    Q,
    ...
    O,
    P,
    #[strum(serialize = "{", serialize = "LeftBrace")]
    LeftBrace,
    #[strum(serialize = "}", serialize = "RightBrace")]
    RightBrace,
    Enter,
    LeftControl,
    A,
    ...
    SemiColon,
    #[strum(serialize = "'", serialize = "Apostrophe")]
    Apostrophe,
    Grave,
    LeftShift,
    BackSlash,
    ...
    Dot,
    #[strum(serialize = "/", serialize = "Slash")]
    Slash,
    RightShift,
    LeftAlt,
    #[strum(serialize = " ", serialize = "Space")]
    Space,
    CapsLock,
    F1,
    F2,
